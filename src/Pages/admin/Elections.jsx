...
const AdminElections = () => {
  ...
  useEffect(() => {
    const fetchElections = async () => {
      try {
        const response = await axios.get("https://election-backend-final-project.onrender.com/elections");
  ...
  const handleCreateElection = async () => {
    ...
    try {
      setIsLoading(true);
      const response = await axios.post("https://election-backend-final-project.onrender.com/elections", {
  ...
  const toggleElectionStatus = async (id, currentStatus) => {
    try {
      ...
      await axios.put(`https://election-backend-final-project.onrender.com/elections/${id}/status`, {
        status: newStatus,
      });
  ...
  const handleDeleteElection = async (id) => {
    ...
    try {
      setIsLoading(true);
      await axios.delete(`https://election-backend-final-project.onrender.com/elections/${id}`);
